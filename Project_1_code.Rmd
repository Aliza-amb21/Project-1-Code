...
GSEA 
log2(adjusted p-value) * sign of the log-fold-change
```{r}
#New data frame to play with
...
#Create a new column that has the log2(adj p-value) multiplied by the sign of the log fold change
